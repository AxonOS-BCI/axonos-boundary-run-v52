...
- **Goal:** dodge red Raw-Signal spikes (−18 integrity) and purple Artifacts (−7); slip past closely for a near-miss bonus. Collect gold Vaults for integrity, score and combo streaks. Gray Gates suspend consent for ~3 s. Periodic **surge waves** raise the pressure.
